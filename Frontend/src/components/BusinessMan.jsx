...
export default function Model(props) {
  ...
  function handleListen() {
    ...
    // alert("inside listen function")

    if(speechSynthesis.speaking){
      props.setSpeechText("");
      props.teacherActions.Animation.halt();
    }
    if (props.mainListen) {
        console.log("Transcript: ", transcript)
        // props.sendLogToBackend("inside Listen :" + "Transcript: ", transcript )
        ...
        resetTranscript()
        props.setmainListen(false)
    } else {
      // props.sendLogToBackend("Else block listen :" + "Play: ")
      console.log("play")
      actions.CC3_Base_Plus_TempMotion.stop()
      actions.CC3_Base_Plus_TempMotion.play()
      // props.sendLogToBackend("Started Listening :")
      SpeechRecognition.startListening()
      props.setmainListen(true)
    }
  }

  // To alter the default position of teacher
  useEffect(() => {
    props.setsuperSetListen(() => handleListen);
  ...
  return (
    <group ref={group} {...props} dispose={null} onClick={(e) => {
      e.stopPropagation();  // To stop multiple events at same time
      handleListen();
    }}>
